...
@WebServlet(name = "orderItemsServlet",value = "/orderItemsServlet")
public class orderItemsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql="select order_time,sum(price*number)as total_price,order_id from (orders natural join order_item) natural join book where user_id=? group by order_id";
